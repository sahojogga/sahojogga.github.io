 ...
 * change: attr("data-sub-html") --> attr("data-title")
 **************************************************/
    ...
    Plugin.prototype.addHtml = function(index) {
        ...
        if (this.s.dynamic) {
            ...
            if ($currentEle.attr('data-sub-html-url')) {
                ...
                subHtml = $currentEle.attr('data-title');
    ...
    */
    ...
    var initializeLibraries = function(images, allowImageShuffle, initializeLightbox) {
        if (images.length > 0) {
            ...
            if (stacks['stacks_in_2_page0'].initializeGrid) {
                stacks['stacks_in_2_page0'].initializeGrid('.stacks_in_2_page0_photo_wrapper', images, function () {
                    if (initializeLightbox) {
                        if (stacks['stacks_in_2_page0'].initializeLightbox) {
                            stacks['stacks_in_2_page0'].initializeLightbox('.stacks_in_2_page0_photo_wrapper', images, function () {
                                //$('#stacks_in_2_page0').toggle();
            ...
            if (stacks['stacks_in_2_page0'].initializeSlider) {
                stacks['stacks_in_2_page0'].initializeSlider('.stacks_in_2_page0_photo_wrapper', images, function () {
                    //$('#stacks_in_2_page0').toggle();
                });
            }
        }
    ...
    stacks['stacks_in_2_page0'].refreshLibraries = initializeLibraries;

    var images = [];
    // Synchrounous
    $.each($('.stacks_in_2_page0_photo_wrapper').children(), function(){
        ...
        // Pulse CMS Blog Gallery
            ...
            $.each($('#stacks_in_1_page0 img').css("display","none"), function() {
                images.push({
                    imgLgSrc:      this.src,
                    imgLgCaption: this.alt,
                    imgSmSrc:      this.src,
    ...
    if (stacks['stacks_in_2_page0'].asyncImageSource) {
        stacks['stacks_in_2_page0'].asyncImageSource(images, function (images) {
...
var jQuery = stacks.jQuery;var $ = jQuery;stacks['stacks_in_2_page0'].initializeGrid = function(selector, images, completeCallback) {
	var html = [];
...
return stack;})(stacks.stacks_in_81_page0);
stacks.stacks_in_68_page0 = {};
stacks.stacks_in_68_page0 = (function(stack) {
var jQuery = stacks.jQuery;var $ = jQuery;stacks['stacks_in_2_page0'].initializeLightbox = function(selector, images, completeCallback) {
	$(selector).lightGallery({
		selector: 'a'
	});
	completeCallback();
};
return stack;})(stacks.stacks_in_68_page0);